        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbarCollapse" style="">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="discover-link"><a href="#contact" class="discover-btn">Test d'éligibilité</a></li>
                </ul>
                <!--end navbar-nav -->
            </div>
            <!--end navbar-collapse -->
...
<section class="home-section" id="home">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>
                    VOTRE DOUCHE SECURISEE <span>GRATUITE</span>
                </h1>
                ...
                <div class="register wow bounceIn" data-wow-delay="0.5s">
                    ...
                    <form id="register-form" class="register-form" action="/server/register.php" method="post">
                        ...
                        <div class="register-step first-step">
                            ...
                            <h3>
                                Êtes-vous <span>éligible</span> à l'aide pour <span>à l'adaptation du logement</span> de
                                 au vieillissement ?
                            </h3>
                        ...
                        <div class="register-step">
                            <h3>Où souhaitez-vous faire des travaux « d’adaptation de mon logement au vieillissement » ?</h3>
                            <label class="checkbox">
                                <input name="fields[7]" value="Oui" type="radio" checked/>
                                <span>Dans le logement que vous occupez (Locataire, propriétaire occupant ou hébergé(e) par un descendant) actuellement</span>
                            </label>
                            <label class="checkbox">
                                <input name="fields[7]" value="Non" type="radio">
                                <span>Dans le logement que vous mettez en location actuellement</span>
                            </label>
                        </div>
